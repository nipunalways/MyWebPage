                  ...
                  <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav">
                        <li class="active"><a href="#">Buy </span></a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
              ...
              <p><b><h1 style="color:#fff; font-family:courier;" class="stat">Buy Property</h1></b></p>
                      <div class="stat">
                           <div class="box1">
              ...
              <div class="row">
                    <div id="display">
                                ...
                                if($city!=""){
                                  ...
                                  $bed = "";
                                  $bath = "";
                                  $sql= "SELECT ESTATE_ID, PRICE, STREET_ADDRESS, BATHROOMS, ROOMS, ZIP, CITY, AREA FROM estate WHERE CITY = '$city' AND SALE_TYPE='B'"; 
                                }
